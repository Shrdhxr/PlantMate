...
class _EditPlantScreenState extends ConsumerState<EditPlantScreen> {
  ...
  late final TextEditingController _wateringFrequencyController;
  late final TextEditingController _fertilizingFrequencyController;
  late final TextEditingController _repottingFrequencyController;
  late final TextEditingController _tagsController;
  
  late SunlightPreference _sunlightPreference;
  late final Set<PlantCategory> _selectedCategories;
  ...
  void initState() {
    ...
    _minTempController = TextEditingController(text: widget.plant.minTemperature.toString());
    _maxTempController = TextEditingController(text: widget.plant.maxTemperature.toString());
    _wateringFrequencyController = TextEditingController(text: widget.plant.wateringFrequencyDays.toString());
    _fertilizingFrequencyController = TextEditingController(text: widget.plant.fertilizingFrequencyDays.toString());
    _repottingFrequencyController = TextEditingController(text: widget.plant.repottingFrequencyMonths.toString());
    _tagsController = TextEditingController(text: widget.plant.tags.join(', '));
    
    _sunlightPreference = widget.plant.sunlightPreference;
    _selectedCategories = widget.plant.categories.toSet();
  ...
  void _updatePlant() {
    if (_formKey.currentState!.validate()) {
      ...
      ref.read(plantsProvider.notifier).updatePlant(updatedPlant);
